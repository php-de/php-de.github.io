...
inhalt:
    ...
    - name: "PHP und extrem große Zahlen"
      anchor: php-typen-und-der-umgang-mit-extrem-grossen-zahlen
      simple: "32bit, 64bit, 128bit"

    - name: "Magie der Binär-Strings"
      anchor: die-magie-der-binaer-strings
...
## [PHP, Typen und der Umgang mit extrem großen Zahlen](#php-typen-und-der-umgang-mit-extrem-grossen-zahlen)
{: #php-typen-und-der-umgang-mit-extrem-grossen-zahlen}
...
## [Die Magie der Binär-Strings](#die-magie-der-binaer-strings)
{: #die-magie-der-binaer-strings}
...
## [Der MySQL-Weg: Die Konvertierung auslagern](#der-mysql-weg-die-konvertierung-auslagern)
