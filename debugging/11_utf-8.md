...
* Datenbankverbindung von PHP zur Datenbank auf UTF-8 stellen. Siehe z.B. [hier für PDO]({{ page.root }}/jumpto/pdo/#create-conn). Für mysqli gibt es die Methode `mysqli_set_charset()` ([PHP-Doku](http://php.net/manual/de/mysqli.set-charset.php)).<br>
