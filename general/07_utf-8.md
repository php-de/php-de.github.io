...
* Fehlender oder falscher Header/Metatag.<br>
Ein `header('Content-Type: text/html; charset=UTF-8');` im PHP-Script löst in vielen Fällen schon das Problem.

* Oder eine sog. Überkodierung: header und Zeichen sind UTF-8, dennoch irgendwo zusätzlich ein `utf8_encode()` (zuviel).


### [Nutze konsequent UTF-8](#konsequent-utf-8)
{: #konsequent-utf-8}
