...
Im nächsten Schritt soll das Script eine URL-Übergabe wiedergeben. Aus Gründen der [Scriptsicherheit](../../jumpto/cross-site-scripting/) fügen wir einen htmlspecialchars-Befehl ein, der sich um die [Maskierung](http://php-de.github.io/general/kontextwechsel.html) (sog. Escaping) schädlicher Eingabewerte kümmert:
